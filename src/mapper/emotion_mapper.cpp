...
const MusicParams EmotionMapper::HAPPY_PARAMS     = {140, "C", "major", 100, "bright",    {0,4,5,3}, "arpeggiated", 2, 7.0};
const MusicParams EmotionMapper::SAD_PARAMS       = { 70, "A", "minor",  60, "melancholic",{0,6,5,6}, "block",       2, 7.0};
const MusicParams EmotionMapper::ANGRY_PARAMS     = {160, "E", "minor", 120, "intense",    {0,3,4,0}, "block",       2, 7.0};
const MusicParams EmotionMapper::SURPRISED_PARAMS = {120, "G", "major",  90, "playful",    {0,3,4,0}, "arpeggiated", 2, 7.0};
const MusicParams EmotionMapper::NEUTRAL_PARAMS   = { 90, "C", "major",  70, "calm",       {0,5,3,4}, "alberti",     2, 7.0};
const MusicParams EmotionMapper::FEAR_PARAMS      = {100, "B", "minor",  80, "tense",      {0,3,4,0}, "arpeggiated", 2, 7.0};
const MusicParams EmotionMapper::DISGUST_PARAMS   = { 80, "F", "blues",  50, "dark",       {0,5,4,3}, "alberti",     2, 7.0};
